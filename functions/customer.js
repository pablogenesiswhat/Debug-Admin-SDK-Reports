...
/**
* Public Function
* Function saveUsageCustomer(auth, data) : null
*
...
* @param object data{
  ...
  * }
  *
  * Generador de reporte de uso por numero de dias del cliente.
  * Este reporte incluye toda la gama de informacion por cliente segun esquema
  */
  module.exports = function (auth, data, callback) {
    console.log("Init Reports Customer Usage Process");
    ...
    const nexToken = function(d) {
      if (days >= d) {
        ...
        service.customerUsageReports.get(params, (err, res) => {
          if (err)
